...
\begin{solution}
    \begin{mltasks}(2)
        \task \prglisting{072-sequences-ctd/01s.code}
        \task \prglisting{072-sequences-ctd/02s.code}
        \task \prglisting{072-sequences-ctd/03s.code}
        \task \prglisting{072-sequences-ctd/04s.code}
        \task \prglisting{072-sequences-ctd/05s.code}
        \task \prglisting{072-sequences-ctd/06s.code}
    \end{mltasks}
\end{solution}
